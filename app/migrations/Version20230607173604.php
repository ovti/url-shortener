 ...
 */
final class Version20230607173604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE urls (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, guest_user_id INT DEFAULT NULL, long_url VARCHAR(255) NOT NULL, short_url VARCHAR(255) NOT NULL, create_time DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_blocked TINYINT(1) NOT NULL, block_expiration DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_2A9437A167B3B43D (users_id), INDEX IDX_2A9437A1E7AB17D9 (guest_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
